<h1 id="title" align="center">Children stories</h1>


> It is a trailer website for a much bigger one coming soon... 
...
```sh
git clone https://github.com/NourMaherT/Chlidren-stories.git
```

Run it using live server extention
